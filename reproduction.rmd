...
```{r comparison, fig.cap='(ref:cells)', echo=FALSE, message=FALSE, warning=FALSE}
knitr::include_graphics("./figures/reproduction/Celltypes.svg")
```

Cells are of two types: eukaryotic, which contain a nucleus, and prokaryotic, which do not. Prokaryotes are single-celled organisms, while eukaryotes can be either single-celled or multicellular.


```{r eupro, out.width='75%', echo=FALSE, message=FALSE, warning=FALSE}
library(tidyverse)
library(printr)        
library(kableExtra)
...
comparison <-  as.tibble(read.csv("data/eukaryote_prokaryote_comp.csv"))

knitr::kable(comparison, col.names = c("","Prokaryotes","Eukaryotes"), digits = 2, align = 'lll', longtable = TRUE, booktabs = TRUE, caption = "Comparison of the main features of prokaryotic and eukaryotic cells.") %>% kable_styling(latex_options = c("striped", "scale_down", "hold_position")) %>% column_spec(1, width = "10em") %>% column_spec(2, width = "10em") %>% column_spec(3, width = "10em")
```
...
```{r animalcell, fig.cap='(ref:animal)', echo=FALSE, message=FALSE, warning=FALSE}
knitr::include_graphics("./figures/reproduction/Animal_cell_structure_en.svg")
```

(ref:plant) [Structure of a typical plant cell](https://commons.wikimedia.org/wiki/File:Plant_cell_structure-en.svg)

```{r plantcell, fig.cap='(ref:plant)', echo=FALSE, message=FALSE, warning=FALSE}
knitr::include_graphics("./figures/reproduction/Plant_cell_structure-en.svg")
```
...
knitr::kable(mitocomp, "latex", digits = 2, align = 'lll', col.names = NULL,  longtable = TRUE, booktabs = TRUE, caption = "Differences between meiosis and mitosis.") %>% kable_styling(latex_options = c("striped", "scale_down", "hold_position")) %>% collapse_rows(columns = 1, latex_hline = "major", valign = "middle") %>% row_spec(c(1,3), extra_latex_after = "\\rowcolor{gray!6}") %>% column_spec(1, width = "10em") %>% column_spec(2, width = "5em") %>% column_spec(3, width = "20em")

#knitr::kable(mitocomp, "html", digits = 2, align = 'lll',  col.names = NULL, longtable = TRUE, booktabs = TRUE, caption = "Differences between meiosis and mitosis.") %>% collapse_rows(columns = 1, latex_hline = "major", valign = "middle") 
#
```
...
```{r cellcycle, fig.cap='(ref:cycle)', echo=FALSE, message=FALSE, warning=FALSE}
