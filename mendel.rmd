...
knitr::include_graphics("./figures/mendel/Independent_assortment_&_segregation.svg")
```
...
(ref:forked) [The major structures in DNA compaction: DNA, the nucleosome, the 10 nm "beads-on-a-string" fibre, the 30 nm fibre and the metaphase chromosome.](https://commons.wikimedia.org/wiki/File:Dihybrid_Cross_Tree_Method.png)
