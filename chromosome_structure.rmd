...
Some of the first sientists to recognize the structures now known as chromosomes were [Matthias Jakob Schleiden](https://en.wikipedia.org/wiki/Matthias_Jakob_Schleiden), [Rudolf Virchow](https://en.wikipedia.org/wiki/Rudolf_Virchow), and [Otto Bütschli](https://en.wikipedia.org/wiki/Otto_B%C3%BCtschli). The term was coined by Heinrich Wilhelm Gottfried von Waldeyer-Hartz, referring to the term chromatin, was introduced by [Walther Flemming](https://en.wikipedia.org/wiki/Walther_Flemming).
