...
Prokaryotic chromosomes have less sequence-based structure than eukaryotes. Bacteria typically have a one-point (the origin of replication) from which replication starts, whereas some archaea contain multiple replication origins. The genes in prokaryotes are often organized in [operons](https://en.wikipedia.org/wiki/Operon), and do not usually contain [introns](https://en.wikipedia.org/wiki/Intron), unlike eukaryotes.
